...
- **الإضافة** : على الهاتف، اضغطوا الزر الدائري « **+** ». وعلى الحاسوب، حدّدوا سطراً ثم « **إضافة بعد** » في الشريط السفلي.
- **التعديل** : اضغطوا على السطر مرتين، أو حدّدوه ثم « **تعديل** ».
...
- **المرجع الرسمي** : بجانب كل قسم، « off. X h » يذكّر بعدد الساعات الأسبوعية الرسمي لمادتكم، وهو مجرد إشارة استرشادية لا قيد.
...
- **تذكير نهاية الحصة** : قبل نهاية الحصة بدقيقة يهتزّ هاتفكم؛ وعند انتهائها يتحقق التطبيق من تسجيل التاريخ. يُفعَّل من **الإعدادات ▸ الإشعارات**.
