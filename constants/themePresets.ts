...
export const BORDER_RADIUS_MAP: Record<BorderRadiusOption, { sm: string; md: string; lg: string; xl: string; '2xl': string; '3xl': string; labelFr: string; labelAr: string }> = {
  sharp: {
    ...
    '2xl': '0px',
    '3xl': '0px',
    labelFr: 'Sharp UI / Angles droits (0px)',
    labelAr: 'زوايا قائمة حادة (0px)',
  },
  default: {
    sm: '0px',
    md: '0px',
    ...
    '2xl': '0px',
    '3xl': '0px',
    labelFr: 'Sharp UI / Standard (0px)',
    labelAr: 'زوايا قائمة قياسية (0px)',
  },
  soft: {
    sm: '0.5rem',
    md: '0.75rem',
