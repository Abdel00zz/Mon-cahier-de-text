...
const buttonVariants = cva(
  "inline-flex cursor-pointer items-center justify-center gap-2 whitespace-nowrap rounded-[var(--radius-md,8px)] text-sm font-medium tracking-[-0.01em] ring-offset-background transition-[transform,box-shadow,background-color,border-color,opacity] duration-200 [transition-timing-function:cubic-bezier(0.2,0,0,1)] will-change-transform active:scale-[0.98] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/40 focus-visible:ring-offset-1 focus-visible:ring-offset-background disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg]:size-[18px]",
  {
    variants: {
      ...
      size: {
        default: "h-10 min-h-[40px] px-5 py-2.5",
        sm: "h-8 min-h-[32px] px-3.5 text-xs font-semibold",
        lg: "h-11 min-h-[44px] px-6 text-base font-semibold",
