...
const buttonVariants = cva(
  "artisanal-button inline-flex cursor-pointer select-none touch-manipulation items-center justify-center gap-2 whitespace-nowrap rounded-[var(--radius-md,8px)] text-sm font-medium tracking-[-0.01em] ring-offset-background transition-[transform,box-shadow,background-color,border-color,opacity] duration-200 [transition-timing-function:cubic-bezier(0.2,0,0,1)] will-change-transform active:scale-[0.97] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/40 focus-visible:ring-offset-1 focus-visible:ring-offset-background disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg]:size-[18px]",
  {
    variants: {
      variant: {
        default: "bg-primary text-primary-foreground font-semibold shadow-xs hover:brightness-110 active:brightness-90",
        charcoal: "bg-[#212123] text-white hover:bg-[#2e2e33] dark:bg-[#2A2A2E] dark:hover:bg-[#34343A] active:scale-[0.97]",
        accent: "bg-primary text-primary-foreground font-semibold shadow-xs hover:brightness-110 active:brightness-90",
