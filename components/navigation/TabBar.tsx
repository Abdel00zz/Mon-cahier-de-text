          ...
          <AnimatePresence>
            {isExpanded && (
              ...
              >
                ...
                <span className={cn(
                  "inline-flex items-center gap-1.5 truncate text-[10px] font-bold tracking-wider text-[#1B6A4D] dark:text-[#FF8252] uppercase mt-1 font-sans bg-[#1B6A4D]/10 dark:bg-[#1B6A4D]/15 px-2 py-0.5 rounded-md",
                  locale === 'ar' && "text-[12px]"
                )}>
                  <span className="h-1.5 w-1.5 rounded-full bg-[#1B6A4D] animate-pulse" aria-hidden="true" />
