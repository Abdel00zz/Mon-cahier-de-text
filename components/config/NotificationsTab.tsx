...
import { Bell, CalendarCheck, Clock, TriangleAlert, X } from '../ui/icons';
        ...
        <div className="space-y-3">
            ...
            <div className="rounded-xl border border-border bg-secondary/35 p-3">
                <div className="flex items-start justify-between gap-3">
                    <div>
                        <h4 className="text-xs font-bold text-foreground">Alertes natives du t̩l̩phone</h4>
                        <p className="mt-1 text-[11px] leading-relaxed text-muted-foreground">
                            Elles apparaissent dans la banni̬re syst̬me, l'̩cran verrouill̩ et le centre de notifications selon les r̩glages du t̩l̩phone.
                        </p>
                    </div>
                    <span className={`shrink-0 rounded-full px-2 py-1 text-[10px] font-bold ${typeof Notification !== 'undefined' && Notification.permission === 'granted' ? 'bg-success/10 text-success' : 'bg-muted text-muted-foreground'}`}>
                        {typeof Notification !== 'undefined' && Notification.permission === 'granted' ? 'Autoris̩es' : 'Non activ̩es'}
                    </span>
                </div>
                <div className="mt-3 grid grid-cols-2 gap-2">
                    <NotificationKind icon={TriangleAlert} label="Retard du cahier" detail="Cron intelligent" />
                    <NotificationKind icon={Clock} label="Fin de s̩ance" detail="Rappel local" />
                    <NotificationKind icon={CalendarCheck} label="Date manquante" detail="Apr̬s le cours" />
