...
import { Printer, CalendarCheck, CalendarDays, FileText } from '../ui/icons';
      ...
      footer={
        <>
          ...
          <Button
            type="button"
            variant="default"
            disabled={mode === 'custom' && selectedDates.size === 0}
            onClick={() => onPrint(mode, { pageNumbers, textSize, lineSpacing }, mode === 'custom' ? Array.from(selectedDates) : undefined)}
          >
            Imprimer {mode === 'new'
