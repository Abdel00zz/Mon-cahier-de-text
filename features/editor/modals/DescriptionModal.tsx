      ...
      <div className="space-y-4">
        ...
        {hasMath && (
          <div className="p-3.5 rounded-xl border border-zinc-200 bg-zinc-50/50 space-y-1.5 animate-fade-in">
            ...
            <div className="bg-white p-3 rounded-lg border border-zinc-200 shadow-inner text-xs text-zinc-800 leading-relaxed overflow-x-auto min-h-[45px] max-h-[150px] overflow-y-auto custom-scrollbar">
