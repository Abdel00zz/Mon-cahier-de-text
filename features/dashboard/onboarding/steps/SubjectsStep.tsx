        ...
        <div className="grid grid-cols-1 gap-2 sm:grid-cols-2">
            {subjects.map(subject => {
                ...
                return (
                    ...
                    >
                        <span className={cn('flex h-6 w-6 shrink-0 items-center justify-center rounded-md border transition-colors', selected ? 'border-[#5064df] bg-[#5064df] text-white' : 'border-slate-300 bg-white text-transparent')}>
