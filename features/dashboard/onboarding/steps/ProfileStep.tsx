...
export const ProfileStep = memo<ProfileStepProps>(
  ({
    ...
    <div className="space-y-5">
      <p className="text-sm leading-relaxed text-[hsl(var(--muted-foreground))] dark:text-[hsl(var(--muted-foreground))]">
      ...
      <details className="keep-surface p-4">
        <summary className="min-h-11 cursor-pointer content-center text-sm font-medium">
          ...
          <span className="text-xs font-normal text-[hsl(var(--muted-foreground))] dark:text-[hsl(var(--muted-foreground))]">
            · {copy.optional}
          </span>
        </summary>
